# 🤖 Guid for launching [Tomarket](https://t.me/Tomarket_ai_bot/app?startapp=00001N6y) bot

![img1](./images/tomarket.png)
...
## Step 1: Preparation
   ...
   * Download and extract the archive or use the command
     ...
     ```
     git clone https://github.com/duonanotte/Tomarket.git
     ```
